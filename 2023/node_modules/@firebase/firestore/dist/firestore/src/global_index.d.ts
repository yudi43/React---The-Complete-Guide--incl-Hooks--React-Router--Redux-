...
interface RemoteDocumentCache {
     ...
     */
    getDocumentsMatchingQuery(transaction: PersistenceTransaction, query: Query$1, offset: IndexOffset, mutatedDocs: OverlayMap): PersistencePromise<MutableDocumentMap>;
    /**
...
declare class LocalDocumentsView {
     ...
     */
    getDocumentsMatchingQuery(transaction: PersistenceTransaction, query: Query$1, offset: IndexOffset): PersistencePromise<DocumentMap>;
    /**
 ...
 */
declare type ExistenceFilterMismatchCallback = (info: ExistenceFilterMismatchInfo) => void;
