 ...
 * @internal
 */
declare class __PRIVATE_TestingHooks {
    /**
     ...
     */ onExistenceFilterMismatch(e: any): () => boolean;
    /**
     * Invokes all currently-registered `onExistenceFilterMismatch` callbacks.
     * @param info Information about the existence filter mismatch.
     */ notifyOnExistenceFilterMismatch(e: any): void;
}
 ...
 */ declare class __PRIVATE_AsyncQueueImpl {
    ...
    Ya: boolean;
    Za: any[];
    Ko: __PRIVATE_ExponentialBackoff;
    Xa: () => void;
     ...
     */ ou(e: any): Promise<void>;
    /**
     * For Tests: Skip all subsequent delays for a timer id.
     */ _u(e: any): void;
    /** Called once a DelayedOperation is run or canceled. */ ru(e: any): void;
}
 ...
 */ declare class __PRIVATE_UserDataReader {
    ...
    serializer: any;
    /** Creates a new top-level parse context. */ Ru(e: any, t: any, n: any, r?: boolean): __PRIVATE_ParseContextImpl;
}
...
declare class __PRIVATE_ExponentialBackoff {
    ...
    No(): void;
    cancel(): void;
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ Oo(): number;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
/** A "context" object passed around while parsing user data. */ declare class __PRIVATE_ParseContextImpl {
    ...
    get path(): any;
    get uu(): any;
    /** Returns a new context with the specified settings overwritten. */ cu(e: any): __PRIVATE_ParseContextImpl;
    lu(e: any): __PRIVATE_ParseContextImpl;
    Iu(e: any): __PRIVATE_ParseContextImpl;
    Tu(e: any): __PRIVATE_ParseContextImpl;
    Eu(e: any): FirestoreError;
...
declare class __PRIVATE_MemoryPersistence {
    ...
    Qr: __PRIVATE_MemoryBundleCache;
    start(): Promise<void>;
    ...
    Ur(e: any, t: any): PersistencePromise;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
declare class __PRIVATE_DatastoreImpl extends __PRIVATE_DatastoreImpl_base {
    ...
    h_: boolean;
    P_(): void;
    /** Invokes the provided RPC with auth and AppCheck tokens. */ Vo(e: any, t: any, n: any): Promise<any>;
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ yo(e: any, t: any, n: any, r: any): Promise<any>;
    terminate(): void;
}
/**
 * @license
 ...
 */ declare class __PRIVATE_RemoteStoreImpl {
    ...
    w_: any[];
    S_: any;
    b_: __PRIVATE_OnlineStateTracker;
}
 ...
 */ declare class __PRIVATE_SyncEngineImpl {
     ...
     */
    Va: Map<any, any>;
    ma: __PRIVATE_ReferenceSet;
    /** Stores user completion handlers, indexed by User and BatchId. */
    fa: {};
    /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    ga: Map<any, any>;
    pa: __PRIVATE_TargetIdGenerator;
    onlineState: string;
 ...
 */ declare class __PRIVATE_WebStorageSharedClientState {
    /** Returns 'true' if WebStorage is available in the current environment. */ static v(e: any): boolean;
    constructor(e: any, t: any, n: any, r: any, i: any);
    window: any;
    ii: any;
    persistenceKey: any;
    ...
    get Ms(): any;
    Ss(): void;
    Cs(e: any, t: any, n: any): void;
    Fs(e: any): void;
    Os(e: any): void;
    xs(e: any, t: any, n: any): void;
    Ns(e: any): void;
    /**
     * Parses a client state key in WebStorage. Returns null if the key does not
     * match the expected key format.
     */ Bs(e: any): string | null;
    /**
     * Parses a client state in WebStorage. Returns 'null' if the value could not
     * be parsed.
     */ ks(e: any, t: any): __PRIVATE_RemoteClientState | null;
    /**
     * Parses a mutation batch state in WebStorage. Returns 'null' if the value
     * could not be parsed.
     */ qs(e: any, t: any): __PRIVATE_MutationMetadata | null;
    /**
     * Parses a query target state from WebStorage. Returns 'null' if the value
     * could not be parsed.
     */ Ks(e: any, t: any): __PRIVATE_QueryTargetMetadata | null;
    /**
     * Parses an online state from WebStorage. Returns 'null' if the value
     * could not be parsed.
     */ bs(e: any): __PRIVATE_SharedOnlineState | null;
    Us(e: any): any;
    Qs(e: any): Promise<any>;
    $s(e: any): any;
    Ls(e: any, t: any): any;
    Ds(e: any): void;
    vs(e: any): SortedSet;
...
declare class __PRIVATE_IndexedDbPersistence {
    ...
    oi: any;
    _i: number;
    Br: __PRIVATE_ListenSequence | null;
    Lr: boolean;
    isPrimary: boolean;
     ...
     */ Ri(): void;
    /** Checks whether `client` is the local client. */ yi(e: any): boolean;
    /**
     ...
     */ pi(e: any): any;
    /** Checks the primary lease and removes it if we are the current primary. */ gi(e: any): any;
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ bi(e: any, t: any): boolean;
    di(): void;
    Mi(): void;
    /**
     ...
     */ Fi(): void;
    /** Removes the zombied client entry if it exists. */ Oi(): void;
    vi(e: any): string;
}
/**
 ...
 */ declare class __PRIVATE_MemoryTargetCache {
     ...
     * IDs.
     */
    Mr: __PRIVATE_ReferenceSet;
    targetCount: number;
    Or: __PRIVATE_TargetIdGenerator;
 ...
 */ declare class __PRIVATE_MemoryIndexManager {
    sn: __PRIVATE_MemoryCollectionParentIndex;
...
declare class __PRIVATE_MemoryRemoteDocumentCacheImpl {
    ...
    vr(e: any, t: any): PersistencePromise;
 ...
 */ declare class LocalDocumentsView {
     ...
     */ getDocumentsMatchingQuery(e: any, t: any, n: any): any;
    /**
    ...
    getDocumentsMatchingCollectionGroupQuery(e: any, t: any, n: any): any;
    getDocumentsMatchingCollectionQuery(e: any, t: any, n: any): any;
}
/**
 ...
 */ declare class __PRIVATE_ReferenceSet {
    ...
    /** Add references to the given document keys for the given ID. */ Tr(e: any, t: any): void;
    /**
...
declare class __PRIVATE_TargetIdGenerator {
    static xn(): __PRIVATE_TargetIdGenerator;
    static On(): __PRIVATE_TargetIdGenerator;
    constructor(e: any);
    Mn: any;
    next(): any;
}
 ...
 */ declare class __PRIVATE_RemoteClientState {
     ...
     */ static cs(e: any, t: any): __PRIVATE_RemoteClientState | null;
    constructor(e: any, t: any);
    clientId: any;
    activeTargetIds: any;
}
...
declare class __PRIVATE_MutationMetadata {
     ...
     * Logs a warning and returns null if the format of the data is not valid.
     */ static cs(e: any, t: any, n: any): __PRIVATE_MutationMetadata | null;
    constructor(e: any, t: any, n: any, r: any);
    user: any;
    batchId: any;
    state: any;
...
declare class __PRIVATE_QueryTargetMetadata {
     ...
     * Logs a warning and returns null if the format of the data is not valid.
     */ static cs(e: any, t: any): __PRIVATE_QueryTargetMetadata | null;
    constructor(e: any, t: any, n: any);
    targetId: any;
    state: any;
    error: any;
 ...
 */ declare class __PRIVATE_SharedOnlineState {
     ...
     * Logs a warning and returns null if the format of the data is not valid.
     */ static cs(e: any): __PRIVATE_SharedOnlineState | null;
    constructor(e: any, t: any);
    clientId: any;
    onlineState: any;
}
 ...
 */ declare class __PRIVATE_SimpleDb {
    ...
    /** Returns true if IndexedDB is available in the current environment. */ static v(): boolean;
    /**
 ...
 */ declare class __PRIVATE_IndexedDbRemoteDocumentCacheImpl {
     ...
     */ er(e: any, t: any): void | MutableDocument;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
declare class __PRIVATE_IndexedDbMutationQueue {
     ...
     */ static lt(e: any, t: any, n: any, r: any): __PRIVATE_IndexedDbMutationQueue;
    constructor(e: any, t: any, n: any, r: any);
    userId: any;
    serializer: any;
    indexManager: any;
    ...
    vn(e: any, t: any): PersistencePromise;
...
declare class __PRIVATE_IndexedDbIndexManager {
     ...
     */
    on: __PRIVATE_MemoryCollectionParentIndex;
    /**
     ...
     * bounds.
     */ hn(e: any, t: any, n: any, r: any, i: any, s: any, o: any): IDBKeyRange[];
    /** Generates the lower bound for `arrayValue` and `directionalValue`. */ In(e: any, t: any, n: any, r: any): __PRIVATE_IndexEntry;
    /** Generates the upper bound for `arrayValue` and `directionalValue`. */ Tn(e: any, t: any, n: any, r: any): __PRIVATE_IndexEntry;
    un(e: any, t: any): any;
    getIndexType(e: any, t: any): PersistencePromise;
    /**
     ...
     * index.
     */ En(e: any, t: any): Uint8Array | null;
    /** Encodes a single value to the ascending index format. */ Pn(e: any): Uint8Array;
    /**
     * Returns an encoded form of the document key that sorts based on the key
     * ordering of the field index.
     */ dn(e: any, t: any): Uint8Array;
    /**
     * Encodes the given field values according to the specification in `target`.
     * For IN queries, a list of possible values is returned.
     */ ln(e: any, t: any, n: any): any[];
    /**
     * Encodes the given bounds according to the specification in `target`. For IN
     * queries, a list of possible values is returned.
     */ cn(e: any, t: any, n: any): any[];
    /** Returns the byte representation for the provided encoders. */ Vn(e: any): any[];
    /**
     ...
     */ Rn(e: any, t: any, n: any): __PRIVATE_IndexByteEncoder[];
    An(e: any, t: any): boolean;
    getFieldIndexes(e: any, t: any): any;
    getNextCollectionGroupToUpdate(e: any): any;
    updateCollectionGroup(e: any, t: any, n: any): any;
    updateIndexEntries(e: any, t: any): PersistencePromise;
    yn(e: any, t: any, n: any, r: any): any;
    wn(e: any, t: any, n: any, r: any): any;
    fn(e: any, t: any, n: any): any;
    /** Creates the index entries for the given document. */ gn(e: any, t: any): SortedSet;
    /**
     * Updates the index entries for the provided document by deleting entries
     * that are no longer referenced in `newEntries` and adding all newly added
     * entries.
     */ pn(e: any, t: any, n: any, r: any, i: any): PersistencePromise;
    mn(e: any): any;
    /**
 ...
 */ declare class __PRIVATE_IndexedDbDocumentOverlayCache {
    static lt(e: any, t: any): __PRIVATE_IndexedDbDocumentOverlayCache;
    /**
...
/** Represents an index entry saved by the SDK in persisted storage. */ declare class __PRIVATE_IndexEntry {
     ...
     * directional value.
     */ Jt(): __PRIVATE_IndexEntry;
}
/**
 * Implements `DirectionalIndexByteEncoder` using `OrderedCodeWriter` for the
 * actual encoding.
 */ declare class __PRIVATE_IndexByteEncoder {
    Gt: __PRIVATE_OrderedCodeWriter;
    zt: __PRIVATE_AscendingIndexByteEncoder;
    jt: __PRIVATE_DescendingIndexByteEncoder;
    seed(e: any): void;
    Ht(e: any): __PRIVATE_AscendingIndexByteEncoder | __PRIVATE_DescendingIndexByteEncoder;
    Wt(): Uint8Array;
    reset(): void;
}
/**
 ...
 */ declare class __PRIVATE_OrderedCodeWriter {
    ...
    Dt(e: any): void;
    Ft(e: any): void;
    /** Writes utf8 bytes into this byte sequence, ascending. */ Ot(e: any): void;
    /** Writes utf8 bytes into this byte sequence, descending */ Nt(e: any): void;
    Bt(e: any): void;
    qt(e: any): void;
    /**
     ...
     */ reset(): void;
    seed(e: any): void;
    /** Makes a copy of the encoded bytes in this buffer.  */ Wt(): Uint8Array;
    /**
     ...
     *   NaN = NaN
     */ Lt(e: any): Uint8Array;
    /** Writes a single byte ascending to the buffer. */ vt(e: any): void;
    /** Writes a single byte descending to the buffer.  */ Mt(e: any): void;
    Ct(): void;
    xt(): void;
    Kt(e: any): void;
    Ut(e: any): void;
